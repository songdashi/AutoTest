...
def test_mov_lat(openpage_st):
    ...
    openpage_st.ele('@id=lateral_pos').input('18590480')
...
def test_mov_long(openpage_st):
    ...
    openpage_st.ele('@id=Longitudinal_pos').input('-29196474')
...
def test_mov_vertical(openpage_st):
    ...
    openpage_st.ele('@id=Vertical_pos').input('-3949215')
...
def test_mov_pitch(openpage_st):
    ...
    openpage_st.ele('@id=Pitch_pos').input('18474042')
...
def test_mov_roll(openpage_st):
    ...
    openpage_st.ele('@id=Roll_pos').input('8686855')
...
def test_mov_iso(openpage_st):
    ...
    openpage_st.ele('@id=Iso_pos').input('22728178')
